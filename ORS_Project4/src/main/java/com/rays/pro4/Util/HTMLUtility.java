...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal,
        ...
        if (select)
        {
        	sb.append("<option style='width: 204px;  height: 30px;' selected value=''>--------------Select---------------------`</option>");
        }
...
;
 ...
 public static String getList(String name, String selectedVal, List list) {
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 204px;  height: 23px;' class='form-control' name='" + name + "'>");
